...
st.header("Предсказание цены объекта с помощью машинного обучения")

st.markdown(r"""Была обучена двухслойная нейронная сеть, 
которая предсказывает цену объекта по следующим признакам:
'Тип объекта', 'ВРИ', 'Расположение относительно КАДа' и 'Площадь'.""")
